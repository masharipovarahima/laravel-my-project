                            ...
                            <div class="modal-body">
                                <form action="{{ route('seminars.update', $seminar->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" name="end_time" class="form-control" value="{{ optional($seminar->end_time)->format('Y-m-d\TH:i') }}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="details" class="form-label">Izoh</label>
