...
<div class="container mt-4">
    <div class="d-flex justify-content-between mb-3">
        ...
        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#createConferenceModal">Yangi Konferensiya Qo'shish</button>
    </div>
                ...
                <tbody>
                    @forelse($conferences as $conference)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editConferenceModal{{ $conference->id }}">Tahrirlash</button>
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $conference->id }}">O'chirish</button>
                            </td>
                        </tr>

                        <!-- Tahrirlash uchun Modal -->
                        <div class="modal fade" id="editConferenceModal{{ $conference->id }}" tabindex="-1" aria-labelledby="editConferenceLabel" aria-hidden="true">
                        ...
                        <div class="modal fade" id="deleteModal-{{ $conference->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <p><strong>{{ $conference->name }}</strong> konferensiyasini o'chirmoqchimisiz?</p>
                                    </div>
                                    <div class="modal-footer">
    ...
    <div class="modal fade" id="createConferenceModal" tabindex="-1" aria-labelledby="createConferenceLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
